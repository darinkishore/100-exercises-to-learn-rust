...
//
// The factorial of `n` is defined as the product of all positive integers up to
// `n`. For example, `5!` (read "five factorial") is `5 * 4 * 3 * 2 * 1`, which
// is `120`. `0!` is defined to be `1`.
//
