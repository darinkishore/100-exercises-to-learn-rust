...
// As a consequence, we don't need the `#[cfg(test)]` attribute for conditional
// compilation—it's implied.
...
#[test]
#[should_panic]
fn test_empty_product_name() { Order::new("".to_string(), 3, 2999,); }

#[test]
#[should_panic]
fn test_long_product_name() { Order::new("a".repeat(301,), 3, 2999,); }

#[test]
#[should_panic]
fn test_zero_quantity() { Order::new("Rust Book".to_string(), 0, 2999,); }

#[test]
#[should_panic]
fn test_zero_unit_price() { Order::new("Rust Book".to_string(), 3, 0,); }
