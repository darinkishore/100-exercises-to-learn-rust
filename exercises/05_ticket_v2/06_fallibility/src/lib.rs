// TODO: Convert the `Ticket::new` method to return a `Result` instead of
// panicking.   Use `String` as the error type.
...
mod tests {
    ...
    fn title_cannot_be_empty() {
        let error = Ticket::new("".into(), valid_description(), Status::ToDo,)
            .unwrap_err();
