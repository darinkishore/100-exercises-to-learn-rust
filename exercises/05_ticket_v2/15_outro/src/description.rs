// TODO: Implement `TryFrom<String>` and `TryFrom<&str>` for the
// `TicketDescription` type,   enforcing that the description is not empty and
// is not longer than 500 characters.   Implement the traits required to make
// the tests pass too.
...
mod tests {
    ...
    fn test_try_from_str() {
        let description =
            TicketDescription::try_from("A description",).unwrap();
        assert_eq!(description.0, "A description");
    }
}
